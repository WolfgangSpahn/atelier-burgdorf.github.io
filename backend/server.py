...
def post_likert():
    ...
    # notify_subscribers(sse_manager, , "LIKERT")
    user = data['user']
...
# curl -X POST -H "Content-Type: application/json" -d '{"answer":"yes", "qid":"q_one", "uuid":"123"}' http://localhost:5000/answer
...
# curl -X GET http://localhost:5000/answer/q_one
...
def serve_frontend():
    ...
    return send_from_directory("../docs", "first.html") # type: ignore
